...
const Contact = () => {
  ...
  return (
    <section id="contact" className="min-h-screen px-6 py-20 bg-[#0F0F0F] text-white">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold mb-12 text-center text-green-400">Contact Me</h2>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Info - unchanged */}
          <div className="bg-[#1B1B1B] p-8 rounded-xl shadow-md space-y-10">
  ...
  <div className="flex items-start gap-4">
    ...
    <div>
      ...
      <p className="text-xl text-gray-300">Davis, California</p>
          ...
          {/* Contact Form */}
          <div className="bg-[#1B1B1B] p-8 rounded-xl shadow-md">
